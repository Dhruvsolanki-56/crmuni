...
export default function Home() {
  ...
  function go(view: View) { setActiveView(view); setMobileNav(false); if (view === 'settings') void loadSettings(); if (view === 'knowledge') void loadKnowledge(); if (view === 'rfqs') void loadRfqs(); if (view === 'events') { void loadEvents(); void loadSettings(); } }
