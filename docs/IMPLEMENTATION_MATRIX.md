...
| Backup restore, load and recovery tests | PARTIAL                              | The full 33-migration chain, integrity and foreign keys are repeatably verified; an operations runbook and load smoke exist. A hosted D1/R2 backup restore drill remains required.                                              |
